const OurValues = () => {
  return (
    <section className="w-full mb-[93px] sm:mb-[60px] px-2 sm:px-4 md:px-10 lg:px-24 py-8 sm:py-12 flex flex-col md:flex-row gap-6 md:gap-10 items-center justify-between bg-white">
      ...
      <div className="md:w-1/2 w-full">
        ...
        <p className="text-sm sm:text-base md:text-base text-black font-medium leading-[150%]">
      ...
      <div className="md:w-1/2 w-full bg-[#BAD6EB] rounded-lg p-4 sm:p-6 md:p-[50px] flex flex-col gap-4 sm:gap-6">
        {/* Reduced padding and gap for mobile */}

        {/* Top Row */}
        <div className="flex flex-col md:flex-row md:divide-x justify-between gap-4 sm:gap-6 md:border-b pb-6">
          {/* Trust */}
          <div className="flex items-start gap-3 sm:gap-4 w-full md:w-1/2">
            <div className="bg-[#091F5B] text-white p-[12px] sm:p-[16px] rounded-full">
               <svg
            ...
            <div>
              <h6 className="text-base sm:text-lg">Trust</h6>
              <p className="text-sm sm:text-base mt-[12px] sm:mt-[16px] text-black font-medium">
          ...
          <div className="flex items-start gap-3 sm:gap-4 w-full md:w-1/2">
            ...
            <div>
              <h6 className="text-base sm:text-lg">Excellence</h6>
              <p className="text-sm sm:text-base mt-[12px] sm:mt-[16px] text-black font-medium">
        ...
        {/* Bottom Row */}
        <div className="flex flex-col md:flex-row md:divide-x justify-between gap-4 sm:gap-6">
          {/* Client-Centric */}
          <div className="flex items-start gap-3 sm:gap-4 w-full md:w-1/2">
            <div className="bg-[#091F5B] text-white p-[12px] sm:p-[16px] rounded-full">
             <svg
            ...
            <div>
              <h6 className="text-base sm:text-lg">Client-Centric</h6>
              <p className="text-sm sm:text-base mt-[12px] sm:mt-[16px] text-black font-medium">
          ...
          <div className="flex items-start gap-3 sm:gap-4 w-full md:w-1/2">
            ...
            <div>
              <h6 className="text-base sm:text-lg">Our Commitment</h6>
              <p className="text-sm sm:text-base mt-[12px] sm:mt-[16px] text-black font-medium">
