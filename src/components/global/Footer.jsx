...
const Footer = () => {
  ...
  return (
    <>
      <section className="w-full py-10 md:py-20 px-4 sm:px-6 overflow-hidden md:px-20 mx-auto">
        {/* Top Section */}
        <div className="w-full">
          {/* Logo & Email */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-7 gap-8 md:gap-4">
            <div className="col-span-1 sm:col-span-2 lg:col-span-2 gap-4 w-full">
              <img
                src={Logo}
                alt="Prop Metaverse"
                className="w-[158px] mb-[20px] mx-auto md:mx-0 md:mb-[50px]"
              />
              <form
                onSubmit={handleSubmit}
                className="flex px-4 mx-auto md:mx-0  items-center w-[305px] bg-logoColor rounded-md overflow-hidden"
              >
                <svg
                ...
                <input
                  ...
                  className="w-full p-2 text-white placeholder-white bg-logoColor outline-none"
                />
                <button className="">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="col-span-1 md:text-start text-center">
              <h3 className="font-bold md:font-[500] text-lg text-logoBlue mb-[16px]">
                Home
              </h3>
              <ul className="space-y-[16px] font-[500] text-base">
                <li>Hero Section</li>
                <li>Features</li>
                <li>Properties</li>
                <li>Testimonials</li>
      ...
      <div className="bg-logoBlue py-4 w-full px-4 sm:px-6 md:px-20 mx-auto">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center space-x-3">
            <Link
              ...
              target="_blank"
              className="bg-gray-800 hover:bg-gray-700 text-white flex items-center justify-center p-[10px] size-[40px] rounded-full transition-colors"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
            ...
            <Link
              ...
              className="bg-gray-800 hover:bg-gray-700 text-white flex items-center justify-center p-[10px] size-[40px] rounded-full transition-colors"
            >
             <BiLogoInstagramAlt className="size-[20px]"/>
            </Link>
          </div>
        </div>
      </div>
