...
const CustomerLeadDetails = ({ setIsOpenLead, isOpenLead }) => {
  const { _id, name, email, phone, date, notes, status, property_id } =
    isOpenLead;
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-gray-700">
          {[
            ...
            { icon: FiMessageSquare, label: "Notes", value: notes },
            {
              ...
              label: "Properties",
              value: (
                <a href={`/projects/property-details/${property_id}`}>
                  View Property
                </a>
              ),
            },
